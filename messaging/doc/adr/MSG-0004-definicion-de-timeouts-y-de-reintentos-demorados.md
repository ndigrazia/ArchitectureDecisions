...
Establecemos tiempo de espera (timeouts) y reintentos demorados en el envío de mensajes al intermediario (broker).
...
Requerimos aplicar tiempos de espera en envío de mensajes y determinar la estrategia en los reintentos: Incremental, Exponencial o Aleatorización.